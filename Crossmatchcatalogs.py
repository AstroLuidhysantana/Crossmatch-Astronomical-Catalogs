...
data = Table.read('YOUR PATH DATA HERE', format='fits')

df_my = data.to_pandas()
df_my.info()

###select just the columns needed for this file
...
if __name__ == "__main__":
    ...
    directory = 'PATH TO YOUR ANCILLARY DATA' ###path yo your general ancillary data
...
final = time.time()
print("time to perform the match:",final - inicio, "seconds")
...
# Create new arrays for the object variables that match the separation condition
...
filtered_table.write('filtered_cataloG.fits', overwrite=True)
